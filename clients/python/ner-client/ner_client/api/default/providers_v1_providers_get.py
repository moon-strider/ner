...
def _get_kwargs() -> dict[str, Any]:
    _kwargs: dict[str, Any] = {"method": "get", "url": "/v1/providers"}
    return _kwargs


def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> ResponseProvidersV1ProvidersGet | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ResponseProvidersV1ProvidersGet]:
    return Response(
...
def sync(*, client: AuthenticatedClient | Client) -> ResponseProvidersV1ProvidersGet | None:
